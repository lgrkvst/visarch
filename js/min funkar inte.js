<html lang="en"><head>
		...
		<script type="text/javascript" src="js/d3.min.bm-w.cornerradius.js"></script><style type="text/css"></style>
	...
	<body>
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<span class="span11">
					<ul class="as-selections" id="as-selections-024"><li class="as-selection-item blur" id="as-selection-475"><a class="as-close">×</a>COIS</li><li class="as-original" id="as-original-024"><input type="text" id="as-input-024" class="input-large search-query as-input" name="q" autocomplete="off"><input type="hidden" class="as-values" name="as_values_024" id="as-values-024" value="COIS,"></li></ul><div class="as-results" id="as-results-024" style="display: none;"><ul class="as-list" style="width: 902px;"><li class="as-result-item active" id="as-result-item-474"><em>COIS</em></li></ul></div>
...
-->
			<div class="row-fluid">
				<div class="span12" oncontextmenu="return false;">
		...
		</div><svg width="1025" height="718"><g class="links"></g><g class="nodes"><g class="node COIS" transform="translate(446.1512004227027,412.6007808726422) rotate(0)"><g class="nodelabel"><text dy=".35em" x="16.1" font-size="14.7" class="nodelabeltext" transform="rotate(0)" text-anchor="start">COIS</text></g><title>7 links
